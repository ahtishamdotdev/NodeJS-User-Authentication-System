...
* Update `cookie` semver lock to address [CVE-2024-47764](https:
 ...
 * remove:
   ...
   - express(1) - moved to [express-generator](https:
 ...
 * refactor:
   - `req.accepts*` with [accepts](https:
   - `req.is` with [type-is](https:
   - [path-to-regexp](https:
 * add:
...
==================
  ...
  * add scheme-relative redirects (`res.redirect("
  * update cookie dep
  * update connect dep
  * update send dep
...
==================
  ...
  * Added route-middleware support (very helpful, see the [docs](http:
...
==================
  ...
  * Added support for layouts using different engines
    ...
    - this.render('page.html.haml', { layout: 'foo' }) 
...
==================
  ...
  * Shameless self promotion of ebook "Advanced JavaScript" (http:
