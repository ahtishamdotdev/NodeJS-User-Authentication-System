5.0.0 / 2023-02-23
==================
 * BREAKING CHANGE: drop callback support #137 [hasezoey](https:
 * BREAKING CHANGE: remove custom promise library support #137 [hasezoey](https:
 * BREAKING CHANGE: remove long deprecated `update`, `remove` functions #136 [hasezoey](https:
 * BREAKING CHANGE: remove collection ducktyping: first param to `mquery()` is now always the query filter #138
 * feat: support MongoDB Node driver 5 #137 [hasezoey](https:
...
4.0.2 / 2022-01-23
==================
 * perf: replace regexp-clone with native functionality #131 [Uzlopak](https:

4.0.1 / 2022-01-20
==================
 * perf: remove sliced, add various microoptimizations #130 [Uzlopak](https:
 * refactor: convert NodeCollection to a class #128 [jimmywarting](https:
...
3.2.5 / 2021-03-29
==================
 * fix(utils): make `mergeClone()` skip special properties like `__proto__` #121 [zpbrent](https:
...
3.1.2 / 2018-08-01
==================
 * chore: move eslint to devDependencies #110 [jakesjews](https:

3.1.1 / 2018-07-30
==================
 * chore: add eslint #107 [Fonger](https:
 * docs: clean up readConcern docs #106 [Fonger](https:

3.1.0 / 2018-07-29
==================
 * feat: add `readConcern()` helper #105 [Fonger](https:
 * feat: add `maxTimeMS()` as alias of `maxTime()` #105 [Fonger](https:
 * feat: add `collation()` helper #105 [Fonger](https:

3.0.1 / 2018-07-02
==================
 * fix: parse sort array options correctly #103 #102 [Fonger](https:
...
2.1.0 / 2016-12-22
==================
 * added; ability to pass an array to select() #81 [dciccale](https:
 ...
 * updated; bluebird to latest 2.10.2 version #74 [matskiv](https:

1.9.0 / 2016-03-15
==================
 * added; `.eq` as a shortcut for `.equals` #72 [Fonger](https:
 * added; ability to use array syntax for sort re: https:
 ...
 * added; `.findCursor()` method #69 [nswbmw](https:
 * added; `_compiledUpdate` property #68 [nswbmw](https:
 ...
 * fixed; do not treat $meta projection as inclusive [vkarpov15](https:

1.6.0 / 2015-05-27
==================

 * update dependencies #65 [bachp](https:
...
==================
  ...
  * fixed; $intersects -> $geoIntersects #14 [ebensing](https:
