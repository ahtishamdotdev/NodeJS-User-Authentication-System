...
[![CII Best Practices](https:

[![npm badge][npm-badge-png]][package-url]

A querystring parsing and stringifying library with some added security.

Lead Maintainer: [Jordan Harband](https:

The **qs** module was originally created and maintained by [TJ Holowaychuk](https:
...
This behavior will not change and is explained in [issue #91](https:
...
If you wish to auto-convert values which look like numbers, booleans, and other values into their primitive counterparts, you can use the [query-types Express JS middleware](https:
