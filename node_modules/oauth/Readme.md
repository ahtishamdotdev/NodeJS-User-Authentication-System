...
Tested against Twitter (http:

Also provides rudimentary OAuth2 support, tested against facebook, github, foursquare, google and Janrain.   For more complete usage examples please take a look at connect-auth (http:

[![Clone in Koding](http:
[koding]: https:
[![Pair on Thinkful](https:
[Thinkful]: http:
...
* 0.10.1
    - OAuth1:   Supports HMAC-256 signature hashing (Non standard, but common signature e.g. https:
...
* Damien Mathieu - http:
* Luke Baker - http:
* Christian Schwarz  - http:
* Joe Rozer - http:
* Garrick Cheung - http:
* rolandboon - http:
* Brian Park - http:
* José F. Romaniello - http:
* bendiy - https:
* Andrew Martins - http:
* Daniel Mahlow - https:
* Pieter Joost van de Sande - https:
* Jeffrey D. Van Alstine
* Michael Garvin
* Andreas Knecht
* AJ ONeal
* Philip Skinner - https:
* Tom Ciborski - https:
* Martino Massalini - https:
* PinyiSong https:
