...
0.7.0 / 2020-03-24
==================
 * BREAKING CHANGE: remove `component.json` #9 [AlexeyGrigorievBoost](https:
...
==================
  ...
  * test; added for #5
  * fix typo that breaks set #5 [Contra](https:
...
==================
  ...
  * add support for using module as a component #2 [Contra](https:
