...
If you're interested in learning more about [character classes](http:
...
console.log(regex.test('50')); 
console.log(regex.test('94')); 
...
Inspired by the python library [range-regex](https:
