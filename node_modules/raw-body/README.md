...
This module includes a [TypeScript](https:
...
- `encoding` - The encoding to use to decode the body into a string.
  ...
  You can use any type of encoding supported by [iconv-lite](https:
...
not map to an encoding supported by the [iconv-lite](https:
module.
